				...
				<form  id="checkoutForm" action="#" method="post">
					...
					<div class="checkout-box-ft">
								...
								<div class="box-bd">
													...
													<div class="col col-1">
														<div class="g-pic">
															<c:forEach items="${od.goods.photoList }" var="p">
																<c:if test="${p.cover==1 }">
																	<img src="../goods/${p.path }" width="40" height="40" />
																</c:if>
															</c:forEach>
														</div>
														<div class="g-info">
															<a href="../goods/detail.do?id=${od.goods.id }" target="_blank">
																${od.goods.name }
															</a>
														</div>
													</div>
													<div class="col col-2">${od.price }</div>
													<div class="col col-3">${od.count }</div>
													<div class="col col-4">${od.lAmount }</div>
												</div>
											</dd>
										</c:forEach>
									</dl>
									<div class="checkout-count clearfix">
										...
										<div class="checkout-price">
											<ul>
												<li>
													订单总额：<span>${odList[0].order.totalAmount }</span>
												</li>
												<li>
													活动优惠：<span>-0元</span>
													<script type="text/javascript">
						...
						<div class="checkout-confirm">
							<a href="../cart/list.do" class="btn btn-lineDakeLight btn-back-cart">返回购物车</a>
							<a id="pay" href="javascript:return false" class="btn btn-primary">立即下单</a>
						</div>
					</div>
			</form>
		</div>
