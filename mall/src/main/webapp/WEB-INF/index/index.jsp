					...
					<div class="yMenuListConin">
						<div class="yMenuLCinList">
							...
							<p>
								...
								<a href="">CPU</a>
								<a href="">主板</a>
								<a href="${pageContext.request.contextPath }/goods/list.do">显卡</a>
								<a href="">硬盘</a>
								<a href="">内存</a>
								<a href="">机箱</a>
								<a href="">电源</a>
	...
	<div class="yBanner">
		<div class="yBannerList">
			<div class="yBannerListIn">
				<a href=""><img class="ymainBanner" src="${pageContext.request.contextPath}/images/banner1.jpg"  width="100%"></a>
				<div class="yBannerListInRight">
					<a href=""><img src="${pageContext.request.contextPath}/images/BR2.png" width="100%"/></a>
					<a href=""><img src="${pageContext.request.contextPath}/images/BR3.png" width="100%" /></a>
				</div>
			</div>
		</div>
		...
		<div class="yBannerList ybannerHide">
			<div class="yBannerListIn">
				<a href=""><img class="ymainBanner" src="${pageContext.request.contextPath}/images/banner1.jpg" width="100%"></a>
				<div class="yBannerListInRight">
					<a href=""><img src="${pageContext.request.contextPath}/images/BR6.png" width="100%"/></a>
					<a href=""><img src="${pageContext.request.contextPath}/images/BR4.png" width="100%" /></a>
				</div>
			</div>
		</div>
		...
		<div class="yBannerList ybannerHide">
			<div class="yBannerListIn">
				<a href=""><img class="ymainBanner" src="${pageContext.request.contextPath}/images/banner1.jpg" width="100%"></a>
				<div class="yBannerListInRight">
					<a href=""><img src="${pageContext.request.contextPath}/images/BR7.png" width="100%"/></a>
					<a href=""><img src="${pageContext.request.contextPath}/images/BR5.png" width="100%" /></a>
				</div>
			</div>
		</div>
	</div>
...
<section id="">
	<div class="center pc-ad-img clearfix">
		<div class="pc-center-img"><img src="${pageContext.request.contextPath}/img/ad/ad1.jpg"></div>
		<div class="pc-center-img"><img src="${pageContext.request.contextPath}/img/ad/ad2.jpg"></div>
		<div class="pc-center-img"><img src="${pageContext.request.contextPath}/img/ad/ad3.jpg"></div>
		<div class="pc-center-img"><img src="${pageContext.request.contextPath}/img/ad/ad4.jpg"></div>
		<div class="pc-center-img"><img src="${pageContext.request.contextPath}/img/ad/ad5.jpg"></div>
	</div>
</section>
<section id="s">
	<div class="center">
										...
										<ul class="flder">
											<li index="0">
												<div class="xsq_deal_wrapper">
													<a class="saleDeal" href="page.html" target="_blank">
														<div class="dealCon">
															<img class="dealImg" src="${pageContext.request.contextPath}/images/xlqg1.jpg" alt="">
												...
												<div class="xsq_deal_wrapper">
													<a class="saleDeal" href="" target="_blank">
														<div class="dealCon">
															<img class="dealImg" src="${pageContext.request.contextPath}/images/xlqg2.jpg" alt="">
															<div class="zt2Qrcode overlay">
																<div class="xsqMask"></div>
																<p class="word1">15:00开抢</p>
																<p class="word2">限100件，抢完恢复25.8元</p>
												...
												<div class="xsq_deal_wrapper">
													<a class="saleDeal" href="" target="_blank">
														<div class="dealCon">
															<img class="dealImg" src="${pageContext.request.contextPath}/images/xlqg3.jpg" alt="">
												...
												<div class="xsq_deal_wrapper">
													<a class="saleDeal" href="" target="_blank">
														<div class="dealCon">
															<img class="dealImg" src="${pageContext.request.contextPath}/images/xlqg4.jpg" alt="">
															<div class="zt2Qrcode overlay">
																<div class="xsqMask"></div>
																<p class="word1">15:00开抢</p>
																<p class="word2">限100件，抢完恢复25.8元</p>
												...
												<div class="xsq_deal_wrapper">
													<a class="saleDeal" href="" target="_blank">
														<div class="dealCon">
															<img class="dealImg" src="${pageContext.request.contextPath}/images/xlqg5.jpg" alt="">
															<div class="zt2Qrcode overlay">
																<div class="xsqMask"></div>
																<p class="word1">15:00开抢</p>
																<p class="word2">限100件，抢完恢复25.8元</p>
												...
												<div class="xsq_deal_wrapper">
													<a class="saleDeal" href="" target="_blank">
														<div class="dealCon">
															<img class="dealImg" src="${pageContext.request.contextPath}/images/xlqg6.jpg" alt="">
															<div class="zt2Qrcode overlay">
																<div class="xsqMask"></div>
																<p class="word1">15:00开抢</p>
																<p class="word2">限100件，抢完恢复25.8元</p>
											...
											<li index="1">
												<div class="xsq_deal_wrapper">
													<a class="saleDeal" href="" target="_blank">
														<div class="dealCon">
															<img class="dealImg" src="${pageContext.request.contextPath}/images/xlqg7.jpg" alt="">
															<div class="zt2Qrcode overlay">
																<div class="xsqMask"></div>
																<p class="word1">15:00开抢</p>
																<p class="word2">限100件，抢完恢复25.8元</p>
												...
												<div class="xsq_deal_wrapper">
													<a class="saleDeal" href="" target="_blank">
														<div class="dealCon">
															<img class="dealImg" src="${pageContext.request.contextPath}/images/xlqg8.jpg" alt="">
															<div class="zt2Qrcode overlay">
																<div class="xsqMask"></div>
																<p class="word1">15:00开抢</p>
																<p class="word2">限100件，抢完恢复25.8元</p>
												...
												<div class="xsq_deal_wrapper">
													<a class="saleDeal" href="" target="_blank">
														<div class="dealCon">
															<img class="dealImg" src="${pageContext.request.contextPath}/images/xlqg9.jpg" alt="">
															<div class="finish overlay">
																<div class="xsqMask"></div>
																<p class="word1">15:00开抢</p>
																<p class="word2">限100件，抢完恢复25.8元</p>
												...
												<div class="xsq_deal_wrapper">
													<a class="saleDeal" href="" target="_blank">
														<div class="dealCon">
															<img class="dealImg" src="${pageContext.request.contextPath}/images/xlqg10.jpg" alt="">
															<div class="zt2Qrcode overlay">
																<div class="xsqMask"></div>
																<p class="word1">15:00开抢</p>
																<p class="word2">限100件，抢完恢复25.8元</p>
												...
												<div class="xsq_deal_wrapper">
													<a class="saleDeal" href="" target="_blank">
														<div class="dealCon">
															<img class="dealImg" src="${pageContext.request.contextPath}/images/xlqg11.jpg" alt="">
															<div class="zt2Qrcode overlay">
																<div class="xsqMask"></div>
																<p class="word1">15:00开抢</p>
																<p class="word2">限100件，抢完恢复25.8元</p>
												...
												<div class="xsq_deal_wrapper">
													<a class="saleDeal" href="" target="_blank">
														<div class="dealCon">
															<img class="dealImg" src="${pageContext.request.contextPath}/images/xlqg12.jpg" alt="">
															<div class="zt2Qrcode overlay">
																<div class="xsqMask"></div>
																<p class="word1">15:00开抢</p>
																<p class="word2">限100件，抢完恢复25.8元</p>
		...
		<div class="pc-center-he">
			...
			<div class="pc-list-goods">
				<div class="xsq_deal_wrapper pc-deal-list clearfix">
					<a class="saleDeal" href="" target="_blank">
						<div class="dealCon"><img class="dealImg" src="${pageContext.request.contextPath}/images/xlqg13.jpg" alt=""></div>
					...
					<a class="saleDeal" href="" target="_blank">
						<div class="dealCon"><img class="dealImg" src="${pageContext.request.contextPath}/images/xlqg14.jpg" alt=""></div>
					...
					<a class="saleDeal" href="" target="_blank">
						<div class="dealCon"><img class="dealImg" src="${pageContext.request.contextPath}/images/xlqg15.jpg" alt=""></div>
						<div class="title_new"><p class="word" title="【京东超市】福临门 葵花籽原香食用调和油5L 中粮出品"><span class="baoyouText">[包邮]</span>【京东超市】福临门 葵花籽原香食用调和油5L 中粮出品</p></div>
						<div class="dealInfo"><span class="price">¥<em>99.9</em></span></div>
					</a>
					<a class="saleDeal" href="" target="_blank">
						<div class="dealCon"><img class="dealImg" src="${pageContext.request.contextPath}/images/xlqg16.jpg" alt=""></div>
					...
					<a class="saleDeal" href="" target="_blank">
						<div class="dealCon"><img class="dealImg" src="${pageContext.request.contextPath}/images/xlqg17.jpg" alt=""></div>
					...
					<a class="saleDeal" href="" target="_blank">
						<div class="dealCon"><img class="dealImg" src="${pageContext.request.contextPath}/images/xlqg18.jpg" alt=""></div>
	...
	<div class="center pc-top-20">
		<div class="pc-center-he">
			...
			<div class="pc-list-goods" style="height:auto">
				<div class="xsq_deal_wrapper pc-deal-list clearfix">
					<a class="saleDeal" href="" target="_blank">
						<div class="dealCon"><img class="dealImg" src="${pageContext.request.contextPath}/images/xlqg19.jpg" alt=""></div>
						<div class="title_new"><p class="word" title="【京东超市】福临门 葵花籽原香食用调和油5L 中粮出品"><span class="baoyouText">[包邮]</span>【京东超市】福临门 葵花籽原香食用调和油5L 中粮出品</p></div>
						<div class="dealInfo"><span class="price">¥<em>39.9</em></span></div>
					</a>
					<a class="saleDeal" href="" target="_blank">
