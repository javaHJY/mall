		...
		$().ready(function(){
			...
			$("#submit").click(function(){
				...
				if(password!=confirmPassword){
					...
					$("#differentPassword").css("display","inline");
					return false;
				}
			})
		})
			...
			<div class="center clearfix">
				...
				<div class="fr pc-login-box">
					...
					<form action="regist.do" method="post">
						...
						<div class="pc-sign">
							<input id="confirmPassword" type="password" placeholder="请确认您的密码">
						</div>
						<div class="pc-sign">
							<input type="password" name="verifycode" placeholder="请输入您的验证码">
							<img id="changeVerify" src="createVerifyCode.do">
							<div id="differentPassword" hidden="hidden">密码不一致</div>
						</div>
						...
						<div class="pc-reg">
							<a href="goLogin.do" class="red">已有账号 请登录</a>
						</div>
					</form>
				</div>
			</div>
